    ...
    public function createPayment($amount, $invoiceId, $txnId, $date)
    {
        $upayResponse = $this->request()
            ...
            ->post($this->baseUrl.'payment/merchant-payment-init/', [
                ...
                'merchant_name' => config('payment.upay.merchant_name'),
                'merchant_code' => config('payment.upay.merchant_code'),
                'merchant_country_code' => 'BD',
                'merchant_city' => config('payment.upay.merchant_city'),
                'merchant_category_code' => config('payment.upay.merchant_category_code'),
                'merchant_mobile' => config('payment.upay.merchant_mobile'),
                'transaction_currency_code' => 'BD',
                'redirect_url' => config('payment.upay.redirect_url'),
            ]);
