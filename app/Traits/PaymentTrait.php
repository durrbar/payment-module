...
use Modules\Payment\Events\PaymentMethods;
...
trait PaymentTrait
{
    ...
    {
        return PaymentIntent::where(function ($query) use ($order_tracking_number): void {
    ...
    {
        // brand & network are equivalent with razorpay & stripe, "network" in durrbar DB
        // type & funding are equivalent with razorpay & stripe, "type" in durrbar DB
